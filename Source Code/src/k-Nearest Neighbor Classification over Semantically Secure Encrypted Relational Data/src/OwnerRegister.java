...
public class OwnerRegister implements ActionListener
{
	...
	{
		frame = new JFrame("Register :: k-Nearest Neighbor Classification over Semantically Secure Encrypted Relational Data");
		panel = new JPanel();
		panel.setLayout(null);
		panel.setBackground(new Color(244,254,131));
