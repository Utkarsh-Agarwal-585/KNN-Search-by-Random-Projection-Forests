...
public class ViewEndUsers extends JFrame implements ActionListener
{
...
setTitle("End Users :: k-Nearest Neighbor Classification over Semantically Secure Encrypted Relational Data");
c= getContentPane();
c.setLayout (null);
