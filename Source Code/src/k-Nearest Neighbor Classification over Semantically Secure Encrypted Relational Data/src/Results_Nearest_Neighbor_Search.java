...
public class Results_Nearest_Neighbor_Search {
  ...
  String fname=null,fname1=null,fname2=null,fname3=null,fname4=null,fname5=null,fname6=null,fname7=null,fname8=null;
    	...
    	try
    	{
    		...
    		String cm="Content Matching";
    		ResultSet rs=st.executeQuery("select * from transaction where task='"+cm+"' ");
    		...
    		while(rs.next()==true)
    		{
    	        ...
    	        JFreeChart chart = ChartFactory.createBarChart3D(
    	                "k-Nearest Neighbor Classification over Semantically Secure Encrypted Relational Data", "SSED Matching Delay Time(MS) ", "Total Delay (MS)",
    	                dataSet, PlotOrientation.VERTICAL, true, true, true);
    	        ChartFrame chartFrame=new ChartFrame("Secure Squared Euclidean Distance (SSED): --- Different Transaction Search Delay Details",chart);
