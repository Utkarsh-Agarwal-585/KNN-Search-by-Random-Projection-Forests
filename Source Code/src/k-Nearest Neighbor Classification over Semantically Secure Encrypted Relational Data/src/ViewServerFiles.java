...
public class ViewServerFiles extends JFrame implements ActionListener
{
...
setTitle("Data Server Files :: k-Nearest Neighbor Classification over Semantically Secure Encrypted Relational Data");
c= getContentPane();
c.setLayout (null);
...
//	 heading.addElement("SL NO");
		...
		heading.addElement("Content");
		heading.addElement("Ranking");
		heading.addElement("Date");
			  ...
			  Dbcon db = new Dbcon();
	             ...
	             String query = "SELECT * From DataServer";
