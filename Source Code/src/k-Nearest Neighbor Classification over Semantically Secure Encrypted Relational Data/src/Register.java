...
public class Register extends JFrame implements ActionListener{
	...
	public Register()
	{
		p=new JPanel();
		p.setLayout(null);
		setTitle("REGISTER::k-Nearest Neighbor Classification over Semantically Secure Encrypted Relational Data");
		p.setBackground(new Color(244,254,131));
...
//		String t7=tf7.getText();
		...
		{
			try {
			if(t1.equalsIgnoreCase("")  || t2.equalsIgnoreCase("") || t3.equalsIgnoreCase("") || t4.equalsIgnoreCase("") || t5.equalsIgnoreCase("") )
			{
			...
			{	
				String ip=JOptionPane.showInputDialog("Enter the Data Server IP address");
